    ...
    <section className="py-24 bg-black">
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-white mb-4">Why Taxation Plans?</h2>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-900/50">
                ...
                <th className="p-5 text-green-500 font-bold border-b border-gray-800">Taxation Plans</th>
        ...
        <p className="mt-6 text-center text-gray-500 text-sm italic">
          * Taxation Plans is built cloud-native for real-time collaboration across offices.
        </p>
      </div>
    </section>
  );
